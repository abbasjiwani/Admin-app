  ...
  return (
    ...
    {PopupRefund && (
      ...
      <div className="bg-white w-[30rem] p-4 rounded-lg shadow-lg">
        ...
        <h2 className="place-content-center justify-center flex text-2xl font-semibold mb-4 text-[#8cd790]">Issue Refund</h2>
        
         <div className="border border-bottom border-[#d4d4d4] w-full"></div>
         <div className="w-[70%] ml-4">

         <p className="mt-5 text-[#959595]">Customer Info</p>
         
         <p className="mt-1 text-[#959595]">Margaret</p>
         <p className="mt-1 text-[#959595]">+1549-69491-2632</p>
         <p className="mt-1 text-[#959595]">margaret@gmail.com</p>



         <p className="mt-5 text-[#959595]">Booking ID</p>
         <p>525848260</p>


         <p className="mt-5 text-[#959595]">Card Details</p>
         <p>**************4269</p>



         <p className="mt-5 text-[#959595]">Payment Date</p>
         <p>MM/DD/YYYY</p>




         <p className="mt-5 text-[#959595]">Payment ID</p>
         <p>256161651961</p>



         <p className="mt-5 text-[#959595]">Refund Amount</p>
         <p>$500</p>
         </div>
        <button
